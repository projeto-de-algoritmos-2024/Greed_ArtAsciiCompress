...
## Uso 
Ao visualizar a art ascii no blocos de notas, ajuste até um ponto adequado para visualização. Ele foi ajustado pelo padrão zoom-out de 20% do bloco de notas (versão Windows 11)
em resolução de tela 1920x1080 (escala= 125%). Feito essa regulagem, todos as artAscii visualizadas nessa proporção de tela sairão conforme o esperado.
